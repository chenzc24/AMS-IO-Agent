...
from src.core.intent_graph.json_validator import validate_config, convert_config_to_list, get_config_statistics
...
def load_templates_from_json(json_file=None):
    ...
    if ams_agent_path:
        ...
        if json_file:
            ...
            possible_files.extend([
                str(ams_agent_base / "device_templates_180.json"),
                str(ams_agent_base / "src" / "app" / "schematic" / "device_templates_180.json"),
                str(ams_agent_base / "src" / "schematic" / "device_templates_180.json"),
                str(ams_agent_base / "src" / "scripts" / "devices" / "device_templates_180.json"),
                str(ams_agent_base / "IO_device_info_T180.json"),
                str(ams_agent_base / "src" / "app" / "schematic" / "IO_device_info_T180.json"),
                str(ams_agent_base / "src" / "schematic" / "IO_device_info_T180.json"),
                str(ams_agent_base / "src" / "scripts" / "devices" / "IO_device_info_T180.json"),
            ])
    ...
    if json_file is None:
        ...
        error_msg = f"Device template file not found for 180nm process node.\n\n"
