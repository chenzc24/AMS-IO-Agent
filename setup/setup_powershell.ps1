...
if (Test-Path $envFile) {
    ...
    if (-not (Test-Path $envBackup)) {
        Write-Info "Creating backup as .env.backup"
        Copy-Item $envFile $envBackup
    }
    Write-Info "Overwriting .env file..."
}
...
# Auto-generated by setup.ps1 (Windows)
# ================================================

# API Configuration
# Replace with your actual API keys
DEEPSEEK_API_KEY=your_deepseek_api_key_here
WANDOU_API_KEY=your_wandou_api_key_here
OPENAI_API_KEY=your_openai_api_key_here

# Model Configuration (optional - can also be set via command line)
...
# ================================================
# Virtuoso Bridge Configuration (Linux Only)
# These settings are for Linux environments with Virtuoso
# ================================================
# USE_RAMIC_BRIDGE=true
# RB_HOST=127.0.0.1
# RB_PORT=65432
# CDS_LIB_PATH=/path/to/cds.lib
"@
